...
<h2 class="accordion-header" id="headingTwo">
    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#candlestick-chart" aria-expanded="false" aria-controls="candlestick-chart">
        Candlestick Chart
    </button>
</h2>
