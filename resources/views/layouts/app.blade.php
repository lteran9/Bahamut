         ...
         <div class="container container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
               <ul class="navbar-nav" style="width: 100%">
                  <li class="nav-item">
                     <a class="nav-link{{ Route::currentRouteNamed('exchange*') ? ' active' : '' }}" aria-current="page"
                        href="{{ route('exchange') }}">Exchange</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link{{ Route::currentRouteNamed('products*') ? ' active' : '' }}"
                  ...
                  <li class="nav-item">
                     <a class="nav-link{{ Route::currentRouteNamed('portfolios*') ? ' active' : '' }}"
